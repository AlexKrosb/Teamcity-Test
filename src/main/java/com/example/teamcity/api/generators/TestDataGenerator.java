...
public class TestDataGenerator {
    public static TestData generate() {
        ...
        var buildType = BuildType.builder()
                ...
                .name(RandomData.getString())
                .project(project)
                //Добавил новое поле в BuildType private Steps steps
                // , нужно проверить правильно ли имплементировал
                .steps(Steps.builder().step(Arrays.asList(Step.builder()
                        .name("Print hello world").type("simpleRunner").properties(Properties.builder()
    ...
    public static Roles generateRoles(com.example.teamcity.api.enums.Role role, String scope) {
        return Roles.builder()
                .role(Arrays.asList(Role.builder()
                        .roleId(role.getText()).scope(scope).build()))
                .build();
    }
}
